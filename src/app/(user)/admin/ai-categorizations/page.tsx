    ...
    <main className="flex flex-1 flex-col gap-6 p-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Last 100 • {items.length} rows • ML pending: {pending.pending_feedback ?? "—"}/{pending.retrain_threshold ?? 10}{" "}
          {pending.error && <span className="text-destructive">({pending.error})</span>}
        </p>
