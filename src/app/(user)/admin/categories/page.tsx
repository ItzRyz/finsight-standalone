...
export default async function AdminCategoriesPage() {
  ...
  return <main className="flex flex-1 flex-col gap-6 p-6"><div><h1 className="text-2xl font-bold tracking-tight">System categories</h1><p className="text-sm text-muted-foreground">Categories shared by every FinSight user.</p></div><SystemCategoryManager categories={categories} /></main>;
}
